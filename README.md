...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1130aab3-5477-4832-ad79-0ee3844d754e
```

> `1130aab3-5477-4832-ad79-0ee3844d754e` is the password of the certificate, you can change it to any password you want.
